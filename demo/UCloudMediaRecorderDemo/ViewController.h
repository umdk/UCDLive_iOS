 ...
 ****************测试线路1****************
 */
//#define RecordDomain(id) [NSString stringWithFormat:@"rtmp://publish3.usmtd.ucloud.com.cn/live/%@", id];
...
//#define PlayDomain(id) [NSString stringWithFormat:@"rtmp://rtmp3.usmtd.ucloud.com.cn/live/%@", id];
//#define PlayDomain(id) [NSString stringWithFormat:@"http://hls3.usmtd.ucloud.com.cn/live/%@/playlist.m3u8", id];
