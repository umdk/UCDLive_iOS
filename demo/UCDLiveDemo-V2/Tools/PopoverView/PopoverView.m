...
//        }
        ...
        CGFloat contentWidth = PopoverViewCellHorizontalMargin*3 + imageWidth + titleLeftEdge + titleWidth * 3;
    ...
    if (maxWidth > CGRectGetWidth(_keyWindow.bounds) - kPopoverViewMargin*3) {
        maxWidth = CGRectGetWidth(_keyWindow.bounds) - kPopoverViewMargin*3;
    }
...
//    }
    FilterPopoverViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kPopoverCellIdentifier];
    if (!cell) {
        cell = [[FilterPopoverViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:kPopoverCellIdentifier];
    }
