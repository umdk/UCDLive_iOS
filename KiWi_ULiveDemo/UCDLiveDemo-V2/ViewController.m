...
{
    NSArray *routeTitles, *directionTitles, *bitrateTitles;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.destinationViewController isKindOfClass:[PublishViewController class]]) {
        PublishViewController *pushLiveVC = segue.destinationViewController;
        pushLiveVC.fps = [_textFieldFPS.text intValue];
        pushLiveVC.route = _route;
        pushLiveVC.direction = _direction;
        pushLiveVC.bitrate = _bitrate;
        pushLiveVC.isPortrait = _isPortrait;
//        pushLiveVC.roomId = _textFieldPublishID.text;
        pushLiveVC.publishUrl = [NSString stringWithFormat:_route, _textFieldPublishID.text];
